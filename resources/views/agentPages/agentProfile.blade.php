...
@section('title') Agent Profile @endsection
@push('customstyle')
   <style>
     .agentProfile {
        background: red;
...
<div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 d-flex justify-content-center">
                    ...
                    <form action="/upload-agent-profile-pic" method="POST" enctype="multipart/form-data" files="true">
                        @csrf
    ...
    <div class="col-md-8 secondhalfdiv">
        <div class="container">
            ...
            <form action="/update-agent-profile" method="POST">
            @else
            <form action="/edit-agent-profile" method="POST">
            @endif 
                @csrf
                <div class="row my-3">
                    <div class="col-md-6">
                ...
                <form action="/change-agent-password" method="POST">
                @csrf
